...
//#####################################################################
// Class TWO_PHASE_MOMENTUM
//#####################################################################
#ifndef __TWO_PHASE_MOMENTUM__
#define __TWO_PHASE_MOMENTUM__
...
//#####################################################################
    // Compute_Au
    bool Compute_Au(const GRID<TV>& grid, const T_FACE_ARRAYS_SCALAR& face_velocities,
            const T_FACE_ARRAYS_SCALAR& surface_area_field,
            T_FACE_ARRAYS_SCALAR& face_velocity_flux);
//#####################################################################
};
}
#endif // __TWO_PHASE_MOMENTUM__
