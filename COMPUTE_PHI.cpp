...
// Constructor
//#####################################################################
template<class TV> COMPUTE_PHI<TV>::
COMPUTE_PHI()
...
// Compute_Phi
//#####################################################################
template<class TV> bool COMPUTE_PHI<TV>::
Compute(const GRID<TV>& grid, const T_FACE_ARRAYS_SCALAR& face_velocities,
...
//#####################################################################
template class COMPUTE_PHI<VECTOR<float,1> >;
template class COMPUTE_PHI<VECTOR<float,2> >;
template class COMPUTE_PHI<VECTOR<float,3> >;
#ifndef COMPILE_WITHOUT_DOUBLE_SUPPORT
template class COMPUTE_PHI<VECTOR<double,1> >;
template class COMPUTE_PHI<VECTOR<double,2> >;
template class COMPUTE_PHI<VECTOR<double,3> >;
#endif
